import { Search, Package, Mail, Phone, MapPin, MessageCircle, Share2, Star, ChevronRight, Check } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="/terms" className="hover:text-violet-400 transition-colors font-semibold">Условия использования</a></li>
                <li><a href="/privacy" className="hover:text-violet-400 transition-colors font-semibold">Политика конфиденциальности</a></li>
                <li><a href="/login" className="hover:text-violet-400 transition-colors font-semibold">Вход</a></li>
                <li><a href="/register" className="hover:text-violet-400 transition-colors font-semibold">Регистрация</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-gray-500">
                <a href="/terms" className="hover:text-violet-400 transition-colors font-semibold">
                  Условия использования
                </a>
                <span>·</span>
                <a href="/privacy" className="hover:text-violet-400 transition-colors font-semibold">
