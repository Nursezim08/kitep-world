            ...
            <form onSubmit={handleSearch} className="flex items-center gap-4 flex-1 max-w-xl mx-8">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 text-sm text-gray-900 placeholder-gray-400"
                />
                {searchQuery && (
                  <button
                    type="button"
      ...
      <div className="flex pt-[57px]">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-4 mb-4 shadow-sm border border-gray-200">
            ...
            >
              {!sidebarCollapsed && (
                <span className="text-sm font-semibold text-gray-500">Навигация</span>
              )}
              <button
