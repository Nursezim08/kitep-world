      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto no-scrollbar shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            {/* Main Grid: Images Left, Fields Right */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-1">
                ...
                {/* Upload Area - Высота равна высоте всех полей справа минус label */}
                <div
                  onDragOver={handleDragOver}
                  onDragLeave={handleDragLeave}
                  onDrop={handleDrop}
                  onClick={handleClick}
                  className={`w-full bg-gray-700 rounded-lg overflow-hidden flex items-center justify-center cursor-pointer transition-all border-2 border-dashed ${
                    isDragging
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    {formData.images.map((image, index) => (
                      <div key={index} className="relative group">
                        ...
                        {index === 0 && (
                          <div className="absolute bottom-1 left-1 px-1.5 py-0.5 bg-violet-500 text-white text-[10px] rounded">
                            Главное
                          </div>
                        )}
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500"
                  ...
                  <div>
                    ...
                    <div ref={categoryRef} className="relative">
                      <button
                        ...
                        className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white text-sm text-left focus:outline-none focus:ring-2 focus:ring-violet-500 transition-all hover:bg-gray-600/50 flex items-center justify-between"
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                      placeholder="0.00"
                    />
                  </div>
                </div>
                ...
                <div className="flex-grow flex items-end">
                  <div>
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-7 w-14 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-gray-800 ${
            ...
            {/* Translations */}
            {LOCALES.map((locale) => (
              <div key={locale.code} className="space-y-3 p-4 bg-gray-700/30 rounded-lg">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-white font-medium text-sm">{locale.name}</h3>
                  {locale.code === 'ru' && (
                    <button
                      type="button"
